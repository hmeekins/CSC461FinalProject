...
public class TutorialText : MonoBehaviour
{
    ...
    switch(TutorialController.Instance.TutorialStep)
    {
        case TutorialStep.GameBasics:
            _tutorial.text = "Welcome to Spiral VR! Your goal is to complete passes and rack up the highest score possible. The farther the pass, the more points you earn. To spawn a ball, press and hold the front trigger.";
            break;
